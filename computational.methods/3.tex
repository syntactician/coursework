...
\end{minted}
\begin{minted}[fontsize=\scriptsize, xleftmargin=0.5em, mathescape, frame = leftline]{text}
...
\end{minted}
\includegraphics[width= \linewidth]{figures/3_q1_table_1.pdf}
...
\end{minted}
\includegraphics[width= \linewidth]{figures/3_q2A_1.pdf}
