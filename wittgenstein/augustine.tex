...
hears \say{slab,} without it \emph{necessarily} being a name for the thing, 
...
% called”)?
and to be told \say{this is the king,} tells one nothing about how to use it.
...
of something can only tell us its use if \say{the place for it is already
prepared,} which is to say that we already understand to what the name refers.
To be told \say{this is the king} only helps if we already know what a king
\emph{is}.
...
\citeA{McGinn97} sums it up well in saying:
\begin{quote}
