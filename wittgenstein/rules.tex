...
\begin{quote}
	...
	% that Saul Kripke sees Wittgenstein to be arguing for in \S 138-242 of
	% the Investigations: ``All we can say is that in our community we call
	% `$125$' the correct answer to `$68 + 57 = ?$'; the idea that it is
	% the correct answer has been shown to be empty''. (This has also been
	% called ``the community view'' on rule-following.)
	%
