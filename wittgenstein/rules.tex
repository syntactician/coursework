...
% \citeA{McDowell09} does seem to give a convincing counterargument to this
% position. He argues (rightly, I think) that Wright's account offers no room
% for ratification-independent truth. An utterance cannot be evaluated without
% a community against which to compare it, and even when such comparison is
% possible, the evaluation of meaning and correctness is not at all what we
% intuitively think of. As he puts it, ``all that my going wrong can amount to
% is this: my action does not secure the approval of my
% fellows''\cite[p.~233]{McDowell98A}.
