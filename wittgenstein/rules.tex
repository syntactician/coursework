...
This seems to be in accordance with what \citep{Wittgenstein53} says in \S 201.
...
\citep{Kripke82}, \emph{not} accordance with any rule. Since meanings cannot be
...
\citet{Wright01} Wright gives a communitarian reading, but one which is some
