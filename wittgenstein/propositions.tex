...
\clearpage
 ...
 \citeA{Wittgenstein22} puts forward in his \emph{Tractatus
...
fact. As \citeA{Speaks07}\footnote{This is a useful handout from the PHIL 43904
...
from \citeA{Speaks07} which look like the propositions with which we are
familiar:    
\begin{equation}
...
\cite{Speaks07}. The operation $ N( \xi ) $, which \citeA{Geach81} describes as
...
% For Wittgenstein, if I understand correctly, the proposition is expression or
% assertion of a state of affairs (\S 

% Wittgenstein, in his Tractatus Logico-Philosophicus, describes the thought as
% ``the significant proposition'' (\S 4). This appears to line up with other
% understandings of the term proposition, 

% Essential to this theory is the idea that the elementary propositions can be
% analyzed such that they produce the set of propositions. 

% \S 3.1

% \cite[\S 3.1]{Wittgenstein22}

% \begin{equation} [ \overline{p}, \overline{\xi}, N(\overline{\xi}) ]
% \end{equation}
