...
something of an allegory.}\autocite{HagerCohen12} Beyond the genre
...
foundations because of things that you've experienced.}\autocite{Brock15}
...
friends},\autocite[p. 133]{Morrison12} and the guilt and shame he felt for for his
...
Sims, considered \say{the father of modern gynecology}, whose work consisted
...
narrator is \say{set on telling [his] story.}\autocite[p.~6]{Morrison12} This
...
this realization gives the reader any \say{pleasure}, but it certainly releases
...
thing as individual pathology.}\autocite{HagerCohen12}
% Good
...
% Braxton,\autocite{Brock15} discusses the concept of moral injury. She
...
% phenomenon, it is far from complete.\autocite{Litz09} However, this work is
...
about the \say{dogfight?} Could he have found any closure without their input?
...
person.  
% But can we believe that Frank would heal, if
% he only \emph{imagined} telling the truth? Frank needed to tell the truth, to
% confess to the reader, and to the other narrator, so that he could begin to
% heal.
...
\say{men-treated-like-dog-fights}\autocite[137]{Morrison12} without the ritual
...
distress, but also to \say{[renew] our relationship to our own humanity, to
...
% \st{Q. What complementary models might Lettini and Brock offer to supplement the work of Litz and Stein? See if you can address this question in the current revision.}
...
% "men turned into dogs" fight? Who might the healers have been? What does the
% text suggest?

% \st{Q. What is the relationship between the two narrators of the text; what is essential about the nature of the dialogue between them for our understanding of the text (and the nature of Frank's invisible wounds)?}
...
% lifelong protection of Cee be interrupted by the women healers in order for Cee
% to heal)?
