...
notable exceptions. When adding /-ta/ would produce /lt/, it is changed to /\textipa{S}/, and when it would produce /dt/, it is changed to /d/.
It would be easy to write a rule \phon{dt}{d}, of course, but I think that
