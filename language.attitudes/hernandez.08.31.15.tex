...
\usepackage{fixltx2e} % provides \textsubscript \ifnum 0\ifxetex 1\fi\ifluatex
...
\usepackage[colorlinks=false]{hyperref} \usepackage{apacite}
...
\begin{figure}[htbp] \centering \includegraphics{ngare.clarke.hernandez}
\end{figure}
...
myself spouting nonsense like: \begin{quote} ``Our alternative is queer
	unintelligibility: This is an enforced invisibility that resists the
	catachresis of the Symbolic that imposes identity on lack in a neurotic
	attempt to map out the blind spots in the social order.''
\cite[p.~19]{Pease11} \end{quote}
...
\bibliography{cmst}{} \bibliographystyle{apacite}
